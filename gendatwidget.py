...
class GenDatWindow(QtWidgets.QWidget):
    """
    ...
    def __init__(self, parent=None):
        ...
        indir_hbox = QtWidgets.QHBoxLayout()
        self.indir_button = QtWidgets.QPushButton("Select Input Directory", self)
        self.indir_textarea = QtWidgets.QLineEdit(self)
        ...
        outdir_hbox = QtWidgets.QHBoxLayout()
        self.outdir_button = QtWidgets.QPushButton("Select Output Directory", self)
        self.outdir_textarea = QtWidgets.QLineEdit(self)
        ...
        self.height_label = QtWidgets.QLabel("Enter Image Height (int)")
        self.height_text = QtWidgets.QLineEdit(self)
        setting_hbox.addWidget(self.height_label)
        setting_hbox.addWidget(self.height_text)

        self.width_label = QtWidgets.QLabel("Enter Image Width (int)")
        self.width_text = QtWidgets.QLineEdit(self)
        setting_hbox.addWidget(self.width_label)
        setting_hbox.addWidget(self.width_text)

        self.depth_label = QtWidgets.QLabel("Select Image Byte Depth")
        self.depth_menu = QtWidgets.QComboBox(self)
        ...
        self.output_button = QtWidgets.QPushButton("Output Files", self)
    ...
    def getInputDirectory(self):
        self.indir = str(QtWidgets.QFileDialog.getExistingDirectory(parent=None,
    ...
    def getOutputDirectory(self):
        self.outdir = str(QtWidgets.QFileDialog.getExistingDirectory(parent=None,
