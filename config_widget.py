...
class ConfigWidget(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.title_label = QtWidgets.QLabel("Enter Settings to Save as YAML File")
        ...
        # file name
        # self.file_name_hbox = QtWidgets.QHBoxLayout()
        self.file_name_field = QtWidgets.QLineEdit()
        # regexp = QtCore.QRegExp('(.+?)(\.[^.]*$|$')
        # validator = QtWidgets.QRegExpValidator(regexp)
        # self.file_name_field.setValidator(validator)
        self.file_name_label = QtWidgets.QLabel("Enter filename without extension")
        ...
        # data directory
        # self.data_dir_hbox = QtWidgets.QHBoxLayout()
        self.data_button = QtWidgets.QPushButton("Select Data Dir", self)
        self.data_button.clicked.connect(self.select_data)
        self.data_label = QtWidgets.QLabel("Click to select a valid data directory")
        ...
        # output directory
        self.output_dir_button = QtWidgets.QPushButton("Select Output Location", self)
        self.output_dir_button.clicked.connect(self.select_output_location)
        self.output_label = QtWidgets.QLabel("Click to select directory to store Experiment YAML file")

        # Exp type
        # self.exp_type_hbox = QtWidgets.QHBoxLayout()
        self.exp_type_menu = QtWidgets.QComboBox(self)
        self.exp_type_menu.addItem("LEED")
        self.exp_type_menu.addItem("LEEM")
        self.exp_type_label = QtWidgets.QLabel("Select Experiment Type")
        ...
        # Data type
        # self.data_type_hbox = QtWidgets.QHBoxLayout()
        self.data_type_menu = QtWidgets.QComboBox(self)
        self.data_type_menu.addItem("Image")
        self.data_type_menu.addItem("Raw")
        self.data_type_label = QtWidgets.QLabel("Select Data Type")
        ...
        # Image type
        # self.image_type_hbox = QtWidgets.QHBoxLayout()
        self.image_type_menu = QtWidgets.QComboBox(self)
        self.image_type_menu.addItem("TIFF")
        self.image_type_menu.addItem("PNG")
        self.image_type_label = QtWidgets.QLabel("Select Image Type")
        ...
        # Data Params
        self.data_params_hbox = QtWidgets.QHBoxLayout()
        self.data_params_hbox.addStretch()
        self.data_params_label = QtWidgets.QLabel("--Data Parameters--")
        self.data_params_hbox.addWidget(self.data_params_label)
        self.data_params_hbox.addStretch()
        self.main_vbox.addStretch()
        self.main_vbox.addLayout(self.data_params_hbox)

        self.im_hbox = QtWidgets.QHBoxLayout()
        self.im_width_field = QtWidgets.QLineEdit()
        self.im_width_field.setValidator(QtWidgets.QIntValidator(bottom=0))
        self.im_width_label = QtWidgets.QLabel("Enter Image Width > 0")
        self.im_hbox.addWidget(self.im_width_field)
        self.im_hbox.addWidget(self.im_width_label)

        self.im_height_field = QtWidgets.QLineEdit()
        self.im_height_field.setValidator(QtWidgets.QIntValidator(bottom=0))
        self.im_height_label = QtWidgets.QLabel("Enter Image Height > 0")
        self.im_hbox.addWidget(self.im_height_field)
        self.im_hbox.addWidget(self.im_height_label)

        self.im_bits_menu = QtWidgets.QComboBox()
        self.im_bits_menu.addItem("8")
        self.im_bits_menu.addItem("16")
        self.im_bits_label = QtWidgets.QLabel("Select Image Bit Depth\n(only for Raw Data)")
        self.im_hbox.addWidget(self.im_bits_menu)
        self.im_hbox.addWidget(self.im_bits_label)

        self.im_byte_order_menu = QtWidgets.QComboBox()
        self.im_byte_order_menu.addItem("Little-Endian (Intel)")
        self.im_byte_order_menu.addItem("Big-Endian (Motorola)")
        self.im_byte_order_label = QtWidgets.QLabel("Select Byte-Order for raw data")
        ...
        # Energy Params
        self.energy_params_label_hbox = QtWidgets.QHBoxLayout()
        self.energy_params_label_hbox.addStretch()
        self.energy_params_label = QtWidgets.QLabel("--Energy Parameters--")
        self.energy_params_label_hbox.addWidget(self.energy_params_label)
        self.energy_params_label_hbox.addStretch()
        self.main_vbox.addStretch()
        self.main_vbox.addLayout(self.energy_params_label_hbox)

        self.energy_params_hbox = QtWidgets.QHBoxLayout()
        self.min_energy_field = QtWidgets.QLineEdit()
        self.min_energy_field.setValidator(QtWidgets.QDoubleValidator())
        self.min_energy_label = QtWidgets.QLabel("Enter Starting Energy in eV")
        self.max_energy_field = QtWidgets.QLineEdit()
        self.max_energy_field.setValidator(QtWidgets.QDoubleValidator())
        self.max_energy_label = QtWidgets.QLabel("Enter Final Energy in eV")
        self.step_energy_field = QtWidgets.QLineEdit()
        self.step_energy_field.setValidator(QtWidgets.QDoubleValidator())
        self.step_energy_label = QtWidgets.QLabel("Enter Step Energy in eV")
        ...
        self.main_vbox.addStretch()
        self.end_button_hbox = QtWidgets.QHBoxLayout()
    ...
    def select_data(self):
        self.data_dir = QtWidgets.QFileDialog.getExistingDirectory(caption="Select Data Directory")
        return

    def select_output_location(self):
        self.output_dir = QtWidgets.QFileDialog.getExistingDirectory(caption="Select location to output .yaml file")
        return
